...
excel_path = os.path.join(table_dir, "TFR_XGB_Model_Performance_Report_interation.xlsx")
...
for i, (clim, econ) in enumerate(top_pairs):
    ...
    scatter = ax.scatter(x_vals, y_vals, c=color_vals, cmap='viridis', s=size_vals, alpha=0.7)
